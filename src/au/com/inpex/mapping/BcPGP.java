...
/*
 * PGP encryption/decryption using the BouncyCastle library.
 */
public class BcPGP {
    ...
    public static void encryptFile(OutputStream out, InputStream is, PGPPublicKey encKey, boolean armor, boolean withIntegrityCheck, int compressType, int encryptType) throws IOException, NoSuchProviderException, PGPException {
